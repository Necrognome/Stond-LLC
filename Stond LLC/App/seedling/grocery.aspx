<%@ Page Title="Grocery List" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="grocery.aspx.vb" Inherits="App_seedling_Default" Async="true" %>
...
<div class="">&nbsp;</div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=192.168.0.34;Initial Catalog=StondLLC;Integrated Security=True;MultipleActiveResultSets=True" SelectCommand="usp_Grocery_Maint" SelectCommandType="StoredProcedure">
                <SelectParameters>
            ...
            <asp:GridView ID="gvGrocery_List" runat="server" DataSourceID="SqlDataSource1" EmptyDataText="Enter Grocery Items" Font-Size="Medium">
                <Columns>
